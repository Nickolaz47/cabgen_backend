...
var baseValidAdminCreateUserBody = map[string]string{
	"name":             "Eddie",
	"username":         "eddy",
	"email":            "eddy@mail.com",
...
var AdminCreateUserTests = []Body{
	// Name
	{"Name required", testutils.ToJSON(func() map[string]string {
		b := testutils.CopyMap(baseValidAdminCreateUserBody)
		b["name"] = ""
		return b
	}()), `{"error":"Name is required."}`},
	{"Name too short", testutils.ToJSON(func() map[string]string {
		b := testutils.CopyMap(baseValidAdminCreateUserBody)
		b["name"] = "Ed"
		return b
	...
	// Username
	{"Username required", testutils.ToJSON(func() map[string]string {
		b := testutils.CopyMap(baseValidAdminCreateUserBody)
		b["username"] = ""
		return b
	...
	// Email
	{"Email required", testutils.ToJSON(func() map[string]string {
		b := testutils.CopyMap(baseValidAdminCreateUserBody)
		b["email"] = ""
		return b
	...
	// Password
	{"Password required", testutils.ToJSON(func() map[string]string {
		b := testutils.CopyMap(baseValidAdminCreateUserBody)
		b["password"] = ""
		return b
	...
	// User Role
	{"Invalid user role", testutils.ToJSON(func() map[string]string {
		b := testutils.CopyMap(baseValidAdminCreateUserBody)
		b["user_role"] = "Tester"
		return b
