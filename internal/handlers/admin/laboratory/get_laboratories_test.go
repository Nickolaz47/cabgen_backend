...
type MockLaboratoryService struct {
	...
	FindAllActiveFunc            func(ctx context.Context) ([]models.Laboratory, error)
...
func (m *MockLaboratoryService) FindAllActive(ctx context.Context) ([]models.Laboratory, error) {
