...
const (
	...
	CountryNotFoundError                      = "admin.country.notFound.error"
	CountryCreateSuccess                      = "admin.country.create.success"
	CountryValidationMissingLanguage          = "admin.country.validation.missingLanguage"
	CountryValidationMissingTranslation       = "admin.country.validation.missingTranslation"
	CountryAlreadyExistsError                 = "admin.country.alreadyExists.error"
	CountryDeleted                            = "admin.country.delete.success"
	...
	ForgotPasswordSuccess                     = "public.auth.forgotPassword.success"
	ResetPasswordSuccess                      = "public.auth.resetPassword.success"
	...
	AdminInvalidActiveQuery                   = "admin.user.search.invalidActiveQuery"
